...
connection = mysql+pymysql://keystone:password@10.26.15.222/keystone
# line 2069 : uncomment
provider = fernet
---------------------------------------------------
...
keystone-manage bootstrap --bootstrap-password adminpassword --bootstrap-admin-url http://10.26.15.222:5000/v3/ --bootstrap-internal-url http://10.26.15.222:5000/v3/ --bootstrap-public-url http://10.26.15.222:5000/v3/ --bootstrap-region-id RegionOne
cp /etc/apache2/apache2.conf /etc/apache2/apache2.conf.bak
echo "ServerName 10.26.15.222" >> /etc/apache2/apache2.conf
...
export OS_AUTH_URL=http://10.26.15.222:5000/v3
...
openstack endpoint create --region RegionOne image public http://10.26.15.222:9292
openstack endpoint create --region RegionOne image internal http://10.26.15.222:9292
openstack endpoint create --region RegionOne image admin http://10.26.15.222:9292
...
connection = mysql+pymysql://glance:password@10.26.15.222/glance
...
openstack endpoint create --region RegionOne compute public http://10.26.15.222:8774/v2.1/%\(tenant_id\)s
openstack endpoint create --region RegionOne compute internal http://10.26.15.222:8774/v2.1/%\(tenant_id\)s
openstack endpoint create --region RegionOne compute admin http://10.26.15.222:8774/v2.1/%\(tenant_id\)s
openstack endpoint create --region RegionOne placement public http://10.26.15.222:8778
openstack endpoint create --region RegionOne placement internal http://10.26.15.222:8778
openstack endpoint create --region RegionOne placement admin http://10.26.15.222:8778
...
# MariaDB connection info
[api_database]
connection = mysql+pymysql://nova:password@10.26.15.222/nova_api

[database]
connection = mysql+pymysql://nova:password@10.26.15.222/nova
...
[placement_database]
connection = mysql+pymysql://placement:password@10.26.15.222/placement
...
Go to "twonodes_compute.sh" file
#########################################NOVA-Compute-Configuration#########################################
...
openstack endpoint create --region RegionOne network public http://10.26.15.222:9696
openstack endpoint create --region RegionOne network internal http://10.26.15.222:9696
openstack endpoint create --region RegionOne network admin http://10.26.15.222:9696
...
# MariaDB connection info
[database]
connection = mysql+pymysql://neutron:password@10.26.15.222/neutron_ml2
...
systemctl restart neutron-api neutron-rpc-server neutron-metadata-agent nova-api
systemctl enable neutron-api neutron-rpc-server neutron-metadata-agent nova-api
...
OPENSTACK_HOST = "10.26.15.222"
OPENSTACK_KEYSTONE_URL = "http://10.26.15.222:5000/v3"
---------------------------------------------------
